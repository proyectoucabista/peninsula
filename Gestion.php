                                        ...
                                        <ul class="menu">
                                            ...
                                            <li><a href="#">Servicios</a>
                                                <ul class="submenu">
                                                    ...
                                                    <li><a href="#">Gestión de Compra</a></li>
                                                    <li><a href="Comercializacion.php">Comercialización de Productos</a></li>
                                                </ul>
                                            </li>
            ...
            <div class="container">
                <div class="row">
                    <div class="general">
                        ...
                        <h3 class="flat-title-section style">Gestión de <span>Compra</span></h3>
                        <div>
                            <p>Cuando se trata del servicios de Gestión de Compra, Peninsula tiene Profesionales capacitados en las que puede confiar.</p>
                            <p>Nuestro propósito es generar valor a su empresa a través de la gestión de compras y contrataciones, basados en esquema de trabajo colaborativo que permite la integración con el equipo del cliente.</p>
                        </div>
                        ...
                        <div class="general-slider services-slider">
                            <div class="flexslider">
                                <ul class="slides">
                                    <li>
                                        <a class="popup-gallery" href="https://imgur.com/vscPft8.jpg
                                        "><img src="https://imgur.com/vscPft8.jpg
                                        " alt="images"></a>
                                    </li>
                                    <li>
                                        <a class="popup-gallery" href="https://imgur.com/CFRT7Jj.jpg
                                        "><img src="https://imgur.com/CFRT7Jj.jpg
                                        " alt="images"></a>
                                    </li>
                                    <li>
                                        <a class="popup-gallery" href="images/services/Ges1.jpg"><img src="images/services/Ges1.jpg" alt="images"></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="sidebar">
                                <div class="widget widget_nav_menu">
                                    <ul class="nav_menu">
                                        ...
                                        <li class="menu-item">
                                            <a class="active" href="#">Gestión de Compra</a>
                                        </li>
                                        <li class="menu-item">
                                    ...
                                    <div class="textwidget">
                                        <div class="content-text">
                                            ...
                                            <ul>
                                                ...
                                                <li><i class="fa fa-arrow-circle-right"></i> Generamos valor a su Empresa</li>
